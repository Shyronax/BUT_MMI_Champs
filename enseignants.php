            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">gestion contenu</p>
                            <!-- Ajoutez un bouton pour ouvrir la modale -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-prof1">
                                Plus de détails
                            </button>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">traitement de l'information</p>
                            <!-- Ajoutez un bouton pour ouvrir la modale -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-prof2">
                                Plus de détails
                            </button>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">UX design / design d'experience</p>
                            <!-- Ajoutez un bouton pour ouvrir la modale -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-prof1">
                                Plus de détails
                            </button>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">CLERY Jean-Marie</h4>
                            <p class="card-text">Matière enseignée</p>
                            <!-- Ajoutez un bouton pour ouvrir la modale -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-prof1">
                                Plus de détails
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">production audio</p>
                            <!-- Ajoutez un bouton pour ouvrir la modale -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-prof1">
                                Plus de détails
                            </button>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Production vidéo</p>
                            <!-- Ajoutez un bouton pour ouvrir la modale -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-prof1">
                                Plus de détails
                            </button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="photo-prof1.jpg" alt="photo du professeur" class="img-fluid mb-3">
                        <p><strong>Nom Prénom</strong> X</p>
                        <p><strong>Présentation matière :</strong> X</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modal-prof1" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="photo-prof9.jpg" alt="photo du professeur" class="img-fluid mb-3">
                        <p><strong>Nom Prénom</strong> X</p>
                        <p><strong>Présentation matière :</strong> X</p>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modal-prof10" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="photo-prof11.jpg" alt="photo du professeur" class="img-fluid mb-3">
                        <p><strong>Nom Prénom</strong> X</p>
                        <p><strong>Présentation matière :</strong> X</p>
                    </div>
                </div>
