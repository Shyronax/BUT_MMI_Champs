    ...
    <div class="container d-flex flex-column flex-lg-row justify-content-between">
        ...
        <div class='d-flex flex-column flex-lg-row'>
            ...
            <div class="col">
                ...
                <p><a href="https://www.instagram.com/mmi_champs/"><span class="visually-hidden">lien page instagram</span><i class="bi bi-instagram"></i> @mmi_champs</a></p>
                <p><a href="https://twitter.com/MMI_Champs"><span class="visually-hidden">lien page twitter</span><i class="bi bi-twitter"></i>@MMI_Champs</a></p>
            </div>
        </div>
    </div>
