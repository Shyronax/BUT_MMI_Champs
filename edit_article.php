...
?>
<body>
<form action="script_edit_article.php?id=<?php echo($_GET['id']) ?>" method="post" enctype="multipart/form-data">
<div class="mb-3 container d-flex flex-column justify-content-center align-items-center w-25 mb-5 mt-5">
    ...
    <!-- <input type="checkbox" name="id" id="" value="" style="display: none;"> -->
