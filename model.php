...
function addProjet($nom_projet, $etudiants, $date_projet, $niveau, $iframe_projet, $lien_projet, $image_projet, $description)
{
    $db = dbConnect();
    $target_dir = 'src/img/projet/';
    $target_file = $target_dir . basename($image_projet);
    move_uploaded_file($image_projet, $target_file);
    $query = "INSERT INTO projet (nom_projet, etudiants, date_projet, niveau, iframe_projet, lien_projet, image_projet, description) VALUES (:nom_projet, :etudiants, :date_projet, :niveau, :iframe_projet, :lien_projet, :image_projet, :description)";
    $stmt = $db->prepare($query);
